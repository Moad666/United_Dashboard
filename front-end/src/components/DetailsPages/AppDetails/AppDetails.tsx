...
import { getLinkFromApp } from '@/utils/application/getLinksFromApp'
import {
  getSMEsFromStr,
...
function ShowAppInfo({ data }: { data: AppProps }) {
...
interface ShowDataProps {
  name: string | keyof AppProps
  value: AppProps[keyof AppProps]
}
...
function LinkSection({ app }: { app: AppProps }) {
  // get links from the application
  const linkGroups = getLinkFromApp(app).filter((link) => link)
  return (
    <div>
      <div>
